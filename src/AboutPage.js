...
const AboutPage = () => {
  ...
  // Return the JSX for the AboutPage component
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex flex-col items-center">
      ...
      <div className="max-w-4xl w-full px-4 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {/* Map through team members and create a card for each */}
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              ...
              <div className="p-4">
                ...
                {/* Button to view team member's profile */}
                <Button 
                  color="blue" 
                  size="small" 
                  onClick={() => alert(`You clicked on ${member.name}'s profile!`)}
                >
                  View Profile
                </Button>
              </div>
